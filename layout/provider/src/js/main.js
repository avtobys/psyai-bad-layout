...
function resetModals() {
  document.querySelectorAll('.modal-mob').forEach(el => {
    el.classList.remove('active');
  });
  document.querySelector('.top-mob').classList.remove('openSidebar');
  let $menu = document.querySelector('.sec-lk__sidebar');
  $menu.classList.remove('active');
  document.querySelector('.top-mob__btn').classList.remove('active');
}

document.querySelector('.top-mob__profile').addEventListener('click', function () {
  let $modal = document.querySelector('.profile-mob');
...
document.querySelector('.top-mob__notify').addEventListener('click', function () {
  let $modal = document.querySelector('.notify-mob');
  if ($modal.classList.contains('active')) {
    $modal.classList.remove('active');
  } else {
    resetModals();
...
document.querySelectorAll('.modal-mob__btn').forEach(el => {
  el.addEventListener('click', function () {
    let $modal = el.closest('.modal-mob');
    if ($modal.classList.contains('active')) {
      $modal.classList.remove('active');
    } else {
      resetModals();
...
// document.querySelector('.top-header__notify .btn-act__top').addEventListener('click', function () {
//   let $wrap = this.closest('.btn-act');
...
// clickOutside('.btn-act', function () {
//   document.querySelectorAll('.btn-act').forEach(el => {
//     el.classList.remove('active');
//   })
// });

document.querySelector('.top-mob__btn').addEventListener('click', function () {
  let $menu = document.querySelector('.sec-lk__sidebar');
  if ($menu.classList.contains('active')) {
    ...
    document.querySelector('.top-mob').classList.add('openSidebar');
    setNoscroll();
  }
});
...
function clickOutside(wrap, func) {
  ['click', 'mouseup'].forEach(evt => {
    document.addEventListener(evt, function (e) {
      let $els = document.querySelectorAll(wrap);
      let countCheck = $els.length;
